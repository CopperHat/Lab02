CREATE DATABASE  IF NOT EXISTS `TuBodeguitaBd` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `TuBodeguitaBd`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: localhost    Database: TuBodeguitaBd
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'TuBodeguitaBd'
--
